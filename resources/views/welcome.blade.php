  ...
  <nav id="sidebar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true " style="display:  none;"> 
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="mx-3 sidebar-brand-text">STC Inventory</div>
      </a>
   ...
   <router-link class="collapse-item" to="/searchorder">Search</router-link>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <!-- TopBar -->
<nav class="mb-4 navbar navbar-expand navbar-light bg-navbar topbar static-top" id="topbar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true " style="display: none;">
    ...
    <router-link to="/logout" class="ml-2 text-white d-none d-lg-inline small">Logout
    </router-link>
              </a>
        ...
        <div class="container my-auto">
          <div class="my-auto text-center copyright">
            <span>copyright &copy; <script> document.write(new Date().getFullYear()); </script> - developed by
              <b><a href="softendev.lpru.ac.th" target="_blank">softendev</a></b>
            </span>
          </div>
        </div>
      </footer>
